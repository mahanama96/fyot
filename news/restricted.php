...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             <strong>Welcome Admin! </strong> to the Navy Dashboard.
                        </div>
 ...
 <i class="fa fa-user fa-5x"></i>
		...
		<script>
					function funcwarn() {
					    alert("Warning! Security clearnce level violation.");
					}
		</script>
